...
@section('title','ویرایش خانواده | آدمک')
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h1 class="mb-sm-0">ویرایش خانواده</h1>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{route('user.dashboard')}}">داشبورد</a></li>
                                <li class="breadcrumb-item"><a href="{{route('user.family.show')}}">خانواده‌ها</a></li>
                                <li class="breadcrumb-item active">ویرایش خانواده</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8 mx-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('user.family.update', $family->id) }}" method="POST">
                                @csrf
                                @method('PUT')

                                <div class="mb-3">
                                    <label for="title" class="form-label">عنوان خانواده <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="title" name="title" value="{{ old('title', $family->title) }}" required>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="father_name" name="father_name" value="{{ old('father_name', $family->father_name) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="mother_name" class="form-label">نام مادر</label>
                                            <input type="text" class="form-control" id="mother_name" name="mother_name" value="{{ old('mother_name', $family->mother_name) }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="is_father_gone" name="is_father_gone" value="1" {{ old('is_father_gone', $family->is_father_gone) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="is_father_gone">پدر فوت کرده است</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="is_mother_gone" name="is_mother_gone" value="1" {{ old('is_mother_gone', $family->is_mother_gone) ? 'checked' : '' }}>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div id="members-container">
                                        @php
                                            $members = old('members', $family->members);
                                            $memberIndex = $members ? count($members) : 1;
                                        @endphp
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="members[{{ $i }}][role]" value="{{ $members[$i]['role'] ?? '' }}" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="mb-3">
                                                                <label class="form-label">سن</label>
                                                                <input type="number" class="form-control" name="members[{{ $i }}][age]" min="1" max="120" value="{{ $members[$i]['age'] ?? '' }}" required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-select" name="members[{{ $i }}][gender]" required>
                                                                    <option value="male" {{ ($members[$i]['gender'] ?? '') == 'male' ? 'selected' : '' }}>مرد</option>
                                                                    <option value="female" {{ ($members[$i]['gender'] ?? '') == 'female' ? 'selected' : '' }}>زن</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="{{ route('user.family.show') }}" class="btn btn-light px-4">انصراف</a>
                                </div>
                            </form>
                        </div>
                    </div>
