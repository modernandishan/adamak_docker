...
@section('title', $category->title . ' - وبلاگ | آدمک')
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h1 class="mb-sm-0">{{ $category->title }}</h1>
            ...
            <div class="row g-4 mb-3">
                <div class="col-sm-auto">
                    <div>
                        <a href="{{url('/admin/posts/create')}}" class="btn btn-soft-success">
                            <i class="ri-add-line align-bottom me-1"></i>افزودن دسته جدید
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- سایر اطلاعات دسته‌بندی -->
                        </div>
                    </div>
                </div>
            </div>--}}

            <!-- نمایش پست‌های دسته‌بندی -->
            <div class="row">
                @foreach($posts as $post)
                    <div class="col-xxl-3 col-lg-6">
                        <div class="card overflow-hidden blog-grid-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">
                                    <a href="{{ route('blog.detail', $post->slug) }}" class="text-reset">
                                        {{ $post->title }}
                                    </a>
                                </h5>
                                ...
                                <a href="{{ route('blog.detail', $post->slug) }}"
                                   class="link link-primary text-decoration-underline link-offset-1">
                                    مطالعه بیشتر
